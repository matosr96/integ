...
def main():
    print("Sistema de Gestión Terapéutica - Herramienta de Inicio")
    print("\nArquitectura profesional detectada:")
    print(" - Dashboard: streamlit run dashboard.py")
    print(" - Scripts de limpieza: scripts/cleanup/")
    print(" - Datos: data/processed/trazabilidad_LIMPIA.json")
